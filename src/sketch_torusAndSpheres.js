...
function setup(){
  ...
  myCamera = new CameraModule(33.2, Math.PI * 0.35);
	myConfig = new Config();
...
class Config{
    ...
    let sld4 = new LineSlider(0.0, 1.0, cur4, createVector(420, 130), createVector(560, 130));
  ...
  drawText(){
    ...
    gr.text("bodyColorChangeSlider", 420, 100);
	}
	update(){
